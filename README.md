...
- [Hamravesh deployment](#hamravesh-deployment)
  ...
  - [3- Setup fastapi app](#3--setup-fastapi-app)
...
surely you are going to need a postgres database or mongodb for your deployment so all you have to do is to create a database app first.
in the app section click on the PostgreSQL/MongoDB database.
